...
# TODO: RASN1 wishlist
#  - SEQUENCE OF SEQUENCE support would be cool, but creating intermediate structures as a workaround
#  - Tracing support, for debugging purposes
#  - Named bit string support, not sure how this would be represented yet though
#  - Allow `name` to be specified as part of `root_options`
...
module Kerberos
  ...
  class AsReq < KdcReq
    root_options class: :application,
                 explicit: 10
  end
      ...
      it 'parses the data successfully' do
        expected = {
          PreAuthEncTimestampDecrypted: {
            pa_timestamp: DateTime.parse('2014-12-09 01:09:09 UTC'),
            pa_usec: 589000
          }
        }
        expect(described_class.parse(valid_data).to_h).to eq(expected)
      ...
      it 'parses the data successfully' do
        expected = {
          EncTicketPart: {
            ...
            authtime: DateTime.parse('2022-06-20 10:39:41 +0000'),
            start_time: DateTime.parse('2022-06-20 10:39:41 +0000'),
            end_time: DateTime.parse('2032-06-17 10:39:41 +0000'),
            renew_till: DateTime.parse('2032-06-17 10:39:41 +0000'),
            authorization_data: [
              {
                ad_type: 1,
    ...
    describe '#parse' do
      it 'parses the data successfully' do
        expected = {
          LastReqItem: {
            lr_type: 0,
            lr_value: DateTime.parse('2022-11-02 12:07:28 UTC')
          }
        }
        ...
        expected = {
          EncKdcRepPart: {
            ...
            last_req: [
              {
                lr_type: 0,
                lr_value: DateTime.parse('2014-12-09T01:09:09+00:00')
              }
            ],
            nonce: 418648108,
            key_expiration: DateTime.parse('2015-01-05T16:08:29+00:00'),
            flags: "P\xE0\x00\x00".b,
            authtime: DateTime.parse('2014-12-09T01:09:09+00:00'),
            starttime: DateTime.parse('2014-12-09T01:09:09+00:00'),
            endtime: DateTime.parse('2014-12-09T11:09:09+00:00'),
            renew_till: DateTime.parse('2014-12-16T01:09:09+00:00'),
            srealm: 'DEMO.LOCAL',
            sname: {
              name_type: 1,
              name_string: ['krbtgt', 'DEMO.LOCAL']
        ...
        expected = {
          EncKdcRepPart: {
            ...
            last_req: [
              {
                lr_type: 0,
                lr_value: DateTime.parse('2022-11-04T18:30:40+00:00')
              }
            ],
            nonce: 65218234,
            flags: "@\xA5\x00\x00".b,
            authtime: DateTime.parse('2022-11-04T18:30:40+00:00'),
            starttime: DateTime.parse('2022-11-04T18:30:40+00:00'),
            endtime: DateTime.parse('2022-11-05T04:30:40+00:00'),
            renew_till: DateTime.parse('2022-11-05T18:30:40+00:00'),
            srealm: 'ADF3.LOCAL',
            sname: {
              name_type: 2,
      ...
      it 'parses the data successfully' do
        expected = {
          Authenticator: {
            ...
            cusec: 719000,
            ctime: DateTime.parse('2014-12-16T22:50:46+00:00'),
            subkey: {
              keytype: 23,
  ...
  describe Kerberos::EncApRepPart do
    ...
    describe '#parse' do
      it 'parses the data successfully' do
        expected = {
          EncApRepPart: {
            ctime: DateTime.parse('2022-11-02T22:56:04+00:00'),
            cusec: 863730,
            subkey: {
              keytype: 18,
  ...
  describe Kerberos::AsReq do
    ...
    describe '#parse' do
      it 'parses the data successfully' do
        expected = {
          KdcReq: {
            ...
            req_body: {
              ...
              from: DateTime.parse('1970-01-01T00:00:00+00:00'),
              till: DateTime.parse('1970-01-01T00:00:00+00:00'),
              rtime: DateTime.parse('1970-01-01T00:00:00+00:00'),
              nonce: 418648108,
              etype: [23],
              addresses: [],
        ...
        expect(described_class.parse(valid_data).to_h[:KdcReq][:req_body]).to eq(expected[:KdcReq][:req_body])
      end
    end
  end
            ...
            ticket_info: [
              {
                ...
                flags: "P\xA0\x00\x00".b,
                authtime: DateTime.parse('2022-09-11T20:58:39+00:00'),
                starttime: DateTime.parse('2022-09-11T20:58:39+00:00'),
                endtime: DateTime.parse('2032-09-08T20:58:39+00:00'),
                renew_till: DateTime.parse('2032-09-08T20:58:39+00:00'),
                srealm: 'DW.LOCAL',
                sname: {
                  name_type: 1,
                  name_string: ['MSSqlSvc', 'dc1.dw.local:1433']
        ...
        it 'parses the data successfully' do
          expected = {
            KrbError: {
              pvno: 5,
              msg_type: 30,
              stime: DateTime.parse('2014-12-14T06:54:01+00:00'),
              susec: 724315,
              error_code: 60,
              cname: { name_type: nil, name_string: [] },
              realm: 'DEMO.LOCAL',
        ...
        it 'parses the data successfully' do
          expected = {
            KrbError: {
              pvno: 5,
              msg_type: 30,
              stime: DateTime.parse('2022-06-21T10:24:41+00:00'),
              susec: 321896,
              error_code: 6,
              crealm: 'DC04',
              cname: {
